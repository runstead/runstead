...
import {
  assertValidMigratedRunsteadRoot,
  type MigrationValidationCheck
} from "./migrate-validation.js";

export {
  validateMigratedRunsteadRoot,
  type MigrationValidationCheck,
  type MigrationValidationCheckStatus
} from "./migrate-validation.js";
...
export async function migrateRunsteadState(
  ...
  await assertValidMigratedRunsteadRoot(source, "Migration source");
  ...
  const validation = await assertValidMigratedRunsteadRoot(
    destination,
