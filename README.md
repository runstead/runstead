...
readiness, skill readiness, runtime environments, entrypoints, approval/evidence
interactions, scheduled checks, webhook intake, and suggested commands without
executing. `--max-tasks <count>` is available for bounded approval-heavy runs.
